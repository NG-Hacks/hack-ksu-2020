...
EXPORT flightRecMod := MODULE
    ...
    EXPORT flightRec := RECORD
        ...
        UNSIGNED4           EffectiveDate;                          // Effective date represents the date that the carrier has scheduled this flight service to begin; YYYYMMDD
        UNSIGNED4           DiscontinueDate;                        // Discontinued date represents the last date that the carrier has scheduled this flight service to operate; YYYYMMDD
